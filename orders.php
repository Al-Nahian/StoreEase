                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        <div class="row p-2 bg-gray-800 text-white border rounded">
                            <div class="col-md-3 mt-1"><img class="img-fluid img-responsive rounded product-image"
                                    ...
                                    src="http://3.bp.blogspot.com/-dmvPv7gCNQw/VZV1cDCvzlI/AAAAAAAAEF4/t-6xUTggF8w/s1600/Missing_Icon.png">
                            </div>
                            <div class="col-md-6 mt-1">
                                <h5 style="font-size:1.5vw; font-weight: 700;">
                                    <?php echo $row["product-name"] ?>
                                </h5>
                                <div class="mt-1 mb-1 spec-1"><span>Brand</span><span
                                        class="dot"></span><span>Category</span><span
                                        class="dot"></span><span>Volume<br></span></div>
                                <div class="mt-1 mb-1 spec-1"><span>N/A</span><span class="dot"></span><span>N/A</span><span
                                        class="dot"></span>N/A<span><br></span></div>
                            ...
                            <div class="align-items-center align-content-center col-md-3 border-left mt-1">
                                <div class="d-flex flex-row align-items-center" style="justify-content: center;">
                                    <h4 class="mr-1" style="font-weight: 700; font-size: 1.5vw">৳
                                        <?php echo $row["rate"] ?> TK
                                    </h4>
                                </div><br>
                                <h4 class="mr-1" style="text-align: center;">In-Stock :
                                    <?php echo $row["Stock"] ?> items
                                </h4>
                                <div class="d-flex flex-column mt-4 justify-center">
                                    <p class="text-center">Quantity : </p><input class="text-black w-16 h-7 mx-24 pt-1"
                                        value="1" type="number" style="text-align: center;">

                                    <button class="btn bg-gray-50 font-semibold btn-sm mt-2" type="button">Add to
                                        cart</button>
                                </div>
                            </div>
                        </div>
