    ...
    <div class="d-flex justify-content-center row">
        ...
        ?>
            <div class="row p-2 bg-white border rounded">
                <div class="col-md-3 mt-1"><img class="img-fluid img-responsive rounded product-image" src="https://www.cookingpitara.com/wp-content/uploads/2020/05/Chocobar-Ice-Cream.jpg"></div>
                ...
                <div class="align-items-center align-content-center col-md-3 border-left mt-1">
                    <div class="d-flex flex-row align-items-center">
                        <h4 class="mr-1" style="align-items: center;"><?php echo $row["rate"] ?> TK </h4>
                    </div>
